import { ShowOverlayService } from './../../drawers/show-overlay.service';
import { Directive, ElementRef, HostListener } from '@angular/core';


@Directive({
  selector: '[sbcGlobalNavTriggerFor]'
})
export class GlobalNavTriggerForDirective {
  constructor(private el: ElementRef, private overlay: ShowOverlayService) {
  ...
  @HostListener('click')openDrawer() {
    // this.overlay.changeOverlay(true);
    // this.drawerName.open();
  }

  @HostListener('click')closeOverlayClick() {
    this.overlay.changeOverlay(true);
  }
